...
<section class="gamesgrid">
    <article class="griditem">
        ...
        <div class="description">
            <a href="https://store.steampowered.com/app/242760/The_Forest/" target="_blank">
                Como único superviviente de un accidente de avión de pasajeros, te encuentras en un misterioso bosque
                luchando por sobrevivir contra una sociedad de mutantes caníbales.
            </a>
        </div>
    </article>
    <article class="griditem">
        ...
        <div class="description">
            <a href="https://store.steampowered.com/app/413150/Stardew_Valley/" target="_blank">
                Acabas de heredar la vieja parcela agrícola de tu abuelo de Stardew Valley. Decides partir hacia una
                nueva vida con unas herramientas usadas y algunas monedas.
            </a>
        </div>
    </article>
    <article class="griditem">
        ...
        <div class="description">
            <a href="https://store.steampowered.com/app/460950/Katana_ZERO/" target="_blank">
                Katana ZERO es un juego de acción y plataformas neo-noir rebosante de personalidad, acción vertiginosa y
                combates de muerte instantánea. Usa tu espada, corre y manipula el tiempo para desvelar tu pasado en un
                despliegue acrobático brutalmente estético.
            </a>
        </div>
    </article>
    <article class="griditem">
        ...
        <div class="description">
            <a href="https://store.steampowered.com/app/220200/Kerbal_Space_Program/" target="_blank">
                En Kerbal Space Program, dirige el programa espacial de una raza alienígena conocida como los Kerbals.
                Utiliza una gran variedad de piezas para construir naves espaciales completamente funcionales que
                volarán (o no) en función de las leyes de la aerodinámica y la física orbital.
            </a>
        </div>
    </article>
    <article class="griditem">
        ...
        <div class="description">
            <a href="https://store.steampowered.com/app/453090/Parkitect/" target="_blank">
                Bienvenido a Parkitect, donde construyes y gestionas los parques temáticos de tus sueños. Construye tus
                propias montañas rusas, diseña un parque que funcione eficientemente y que sumerja a tus invitados en su
                temática y juegue a través de la campaña.
            </a>
        </div>
    </article>
    <article class="griditem">
        ...
        <div class="description">
            <a href="https://store.steampowered.com/app/589290/Holdfast_Nations_At_War/" target="_blank">
                Holdfast: Nations At War es un juego de disparos en línea multijugador en primera y tercera persona que
                se centra en una combinación de trabajo en equipo y habilidad individual. Participa en enfrentamientos
                históricos librados durante la gran era napoleónica.
            </a>
        </div>
    </article>
    <article class="griditem">
        ...
        <div class="description">
            <a href="https://store.steampowered.com/app/613100/House_Flipper/" target="_blank">
                House Flipper te ofrece una oportunidad única para convertirte en un equipo
                de reformas de una sola persona. Compra, repara y mejora casas en ruinas.
                ¡Dales una segunda vida y obtén beneficios vendiéndolas!
            </a>
        </div>
    </article>
    <article class="griditem">
        ...
        <div class="description">
            <a href="https://store.steampowered.com/app/252950/Rocket_League/" target="_blank">
                ¡El fútbol se une a los coches una vez más en la esperada continuación basada en la física del querido
    ...
    <article class="griditem">
        ...
        <div class="description">
            <a href="https://store.steampowered.com/app/105600/Terraria/" target="_blank">
                ¡Cava, lucha, explora, construye! Nada es imposible en este juego de aventuras repleto de acción. El
                mundo es tu lienzo y la tierra misma es tu pintura.
            </a>
        </div>
    </article>
</section>
